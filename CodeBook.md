---
title: "Peer-graded Assignment: <br>Getting and Cleaning Data Course Project"
author: "Lars Hofmann"
...
## Merging the training and the test sets to create one data set and labeling the data set with descriptive variable names
...
### DONE - The clean R code is written in file ***run_analysis.R***
